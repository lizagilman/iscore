...
export const Match = (playerA, playerB, winner, style1, matchId, score) => (
  <Paper
    ...
    onMouseEnter={(e) => {
      e.preventDefault();
      document.getElementById(`score-${matchId}`).style.display = 'block';
    }}
    onMouseLeave={(e) => {
      e.preventDefault();
      document.getElementById(`score-${matchId}`).style.display = 'none';
    }}
  >
    <div
      style={
      ...
      <table>
        <tr>
          ...
          <td className={score.p1_set3 > score.p2_set3 ? 'setWinner' : false}>
            {score.p1_set3 || score.p2_set3 ? score.p1_set3 : false}
          </td>
        </tr>
        <tr>
          ...
          <td className={score.p2_set3 > score.p1_set3 ? 'setWinner' : false}>
            {score.p2_set3 || score.p1_set3 ? score.p2_set3 : false}
          </td>
        </tr>
      </table>
    </div>
