...
import { startAnimation } from './button_animation'
import './work_button.css'

@observer
class WorkButtonComponent extends Component {
    ...
    render(){
        return(
            //<button className="btn btn-primary" data-toggle="modal" data-target="#work_button">test</button>
            <button id ="unicorn" className="icobutton icobutton--unicorn" data-toggle="modal" data-target="#work_button">
...
export default WorkButtonComponent;
