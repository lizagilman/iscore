...
class Grades(models.Model):
    ...
    points = models.OneToOneField(
        Points_Distribution_Methods, on_delete=models.CASCADE,null=True, blank=True)
    money = models.OneToOneField(
        Money_Distribution_Methods, on_delete=models.CASCADE,null=True, blank=True)
...
class Organizations(models.Model):
    name = models.CharField(db_index=True, max_length=300)
    points_list = models.ManyToManyField(Points_Distribution_Methods,null=True, blank=True)
    money_list = models.ManyToManyField(Money_Distribution_Methods,null=True, blank=True)
...
class Rankings_list_catagories(models.Model):
    ...
    player = models.ForeignKey(Players, on_delete=models.DO_NOTHING,null=True, blank=True)
