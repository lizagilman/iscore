...
class Ranking_Lists(models.Model):
    name = models.CharField(db_index=True, max_length=300)
    grades=models.ManyToManyField(Grades) #also creates the joining table between Ranking_List and Grade(Rules Table)
    def __str__(self):
        return self.name
...
class Matches(models.Model):
    ...
    player2= models.ForeignKey(Players, on_delete=models.DO_NOTHING,related_name="%(class)s_player2")
